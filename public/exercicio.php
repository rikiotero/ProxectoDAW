      ...
      <input type="hidden" name="idExerc" id="idExerc" value="<?php echo isset($_GET["id"]) ? $_GET["id"] : ""?>">
        ...
        <div class="row g-3 align-items-center">
          ...
          <div class="form-group col-md-2 mt-5">
            <input class="form-check-input" type="checkbox" name="exercActivo" id="exercActivo" value="1" 
            <?php echo $exercicio->getActivo() == 1 ? "checked" : ""?>
            <?php echo $_SESSION["rol"] == "estudiante" ? "disabled" : ""?>>
            <label class="form-check-label" for="exercActivo">Activo</label>
          </div>
